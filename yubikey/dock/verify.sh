...
RESULT="$(pkcs11-tool --module /usr/lib/x86_64-linux-gnu/libykcs11.so --verify --signature-format openssl -m ECDSA-SHA256 --id 02 --input-file digest.bin --signature-file signature.bin --pin 81728172)"
